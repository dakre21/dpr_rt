...
HD_PWD='/home/dakre/dpr_rt/hw/Sources/lab/managed_ip_project/managed_ip_project.runs/axi_rtl_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axi_rtl.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axi_rtl.tcl
