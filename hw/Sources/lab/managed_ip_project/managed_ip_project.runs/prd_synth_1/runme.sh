...
HD_PWD='/home/dakre/dpr_rt/hw/Sources/lab/managed_ip_project/managed_ip_project.runs/prd_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log prd.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source prd.tcl
