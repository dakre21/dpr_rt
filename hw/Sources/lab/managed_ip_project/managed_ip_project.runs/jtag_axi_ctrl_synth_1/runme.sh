...
HD_PWD='/home/dakre/dpr_rt/hw/Sources/lab/managed_ip_project/managed_ip_project.runs/jtag_axi_ctrl_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log jtag_axi_ctrl.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source jtag_axi_ctrl.tcl
