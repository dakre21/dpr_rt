...
#
# Generated by export_simulation on Thu Apr 26 20:47:21 MDT 2018
#
################################################################################
...
'-reset_run' switch to the './prc.sh' script.
...
./prc.sh -noclean_files

For more information on the script, please type './prc.sh -help'.
