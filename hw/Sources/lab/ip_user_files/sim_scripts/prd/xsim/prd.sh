...
elaborate()
{
  xelab --relax --debug typical --mt auto -L lib_cdc_v1_0_2 -L pr_decoupler_v1_0_5 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot prd xil_defaultlib.prd xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim prd -key {Behavioral:sim_1:Functional:prd} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb prd.wdb xsim.dir)
