...
elaborate()
{
  xelab --relax --debug typical --mt auto -L fifo_generator_v13_1_4 -L axi_interconnect_v1_7_13 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot axi_rtl xil_defaultlib.axi_rtl xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim axi_rtl -key {Behavioral:sim_1:Functional:axi_rtl} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb axi_rtl.wdb xsim.dir)
